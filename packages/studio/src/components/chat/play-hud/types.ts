...
export const KIND_LABEL_VI: Record<string, string> = {
  item: "Vật phẩm", evidence: "Bằng chứng", clue: "Manh mối", claim: "Tuyên bố", proof_chain: "Chuỗi chứng cứ",
};
...
export const LADDER_LABEL_VI: Record<string, string> = {
  ...
  verified: "Đã xác minh", weaponized: "Đã vũ khí hóa", exposed: "Đã phơi bày", exhausted: "Đã dùng hết",
};
