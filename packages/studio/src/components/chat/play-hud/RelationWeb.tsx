...
export function RelationWeb(props: {
  ...
  const ariaLabel = props.lang === "zh" ? "关系网" : props.lang === "vi" ? "Mạng quan hệ" : "Relations";
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="block w-full min-w-0" role="img" aria-label={ariaLabel}>
      {nodes.map((n, i) => (
