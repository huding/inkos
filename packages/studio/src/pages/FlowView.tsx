  ...
  return (
    <div className="flex flex-col h-full p-5 gap-3" data-testid="flow-view">
      <div className="flex items-center gap-3 text-sm shrink-0">
        ...
        >
          {editing ? tr("完成编辑", "Done editing", "Hoàn tất chỉnh sửa") : tr("编辑", "Edit", "Chỉnh sửa")}
        </button>
        {editing && (
          <button
      ...
      {stats && (
        ...
        >
          ...
          <span>{tr("分支", "Branches", "Phân nhánh")} {stats.branch}</span>
          ...
          <span className="ml-auto flex items-center gap-3">
            ...
            <span className="flex items-center gap-1">
              ...
              {tr("悬停路径", "Hover path", "Đường dẫn di chuột")}
            </span>
          </span>
        </div>
      )}
